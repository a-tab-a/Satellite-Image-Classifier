""" Train CNN model to Classify Satellite Image Data from Sat-4 Dataset; RGB-NIR channel"""
...
class SatFourDatasetIR(Dataset):
    ...
    def __getitem__(self,idx):
        ...
        #image=rgb_transform(image[:3,:,:])
        #image_rgb=rgb_transform(image_rgb)
...
#Transform dataset
transformed_train_dataset=SatFourDatasetIR(mat_file='sat-4-full.mat',transform=transforms.ToTensor())
...
for epoch in range(1, n_epochs+1):
    ...
    if valid_loss <= valid_loss_min:
        ...
        valid_loss_min,
        valid_loss))
        torch.save(model.state_dict(), 'model_IRSat4.pt')

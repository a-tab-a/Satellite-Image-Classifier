""" CNN model to Classify Satellite Image Data from Sat-4 Dataset; Considers only RGB channel"""
...
#Load Test data
transformed_test_dataset=SatFourDataset(mat_file='sat-4-full.mat',transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))]))
...
model.load_state_dict(torch.load('model_Sat4.pt'))
